...
function detectScreen() {
    ...
    switch (active && active.id) {
        case 'screen-pre': return 'Pre-LBD (Start)';
        // Part 1 — charge the low battery (parts → whole)
        case 'screen-1':   return 'P1 · Choose Bot';
        case 'screen-2':   return 'P1 · Charge Puzzle';
        case 'screen-3':   return 'P1 · Charged Bot';
        case 'screen-4':   return 'P1 · Concept (parts make whole)';
        // Part 2 — fix the overcharged bot (whole → parts)
        case 'screen-5':   return 'P2 · Overcharged Intro';
        case 'screen-6':   return 'P2 · Split Puzzle';
        case 'screen-7':   return 'P2 · Fixed Bot';
        case 'screen-8':   return 'P2 · Concept (whole into parts)';
