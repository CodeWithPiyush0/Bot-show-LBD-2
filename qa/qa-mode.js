...
// This game is a single-page flow of stacked <section class="screen"> panels
// inside #stage; exactly one carries `.is-active` at a time (toggled by
// GameNav.show). We read that active screen's id and map it to a label.
function detectScreen() {
    const active = document.querySelector('#stage .screen.is-active');
    switch (active && active.id) {
        case 'screen-pre':        return 'Start';
        case 'screen-1':          return 'Choose Bot';            // 3-bot tutorial / 5-bot chooser
        case 'screen-2':          return 'Code Puzzle';           // sort the number codes into slots
        case 'screen-3':          return 'Bot Fixed (dance)';
        case 'screen-4':          return 'Concept (parts & whole)';
        case 'screen-turn':       return 'Your Turn';             // Bite flying interstitial
        case 'screen-transition': return 'Level Transition';
        // screens 5-8 are the dormant Part-2 flow (not reached in this game)
        case 'screen-5':          return 'Unused · P2 Intro';
        case 'screen-6':          return 'Unused · P2 Puzzle';
        case 'screen-7':          return 'Unused · P2 Fixed';
        case 'screen-8':          return 'Unused · P2 Concept';
